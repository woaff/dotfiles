...
" Enable ale auto close preview when insert
...
let lspServers = [
			...
			\ #{
			\   name: 'efm-langserver',
			\   filetype: ['cds', 'css', 'go', 'html', 'javascript', 'json', 'jsonc', 'markdown', 'python', 'sh', 'toml', 'vim', 'yaml'],
...
" Plug 'tokorom/asyncomplete-dictionary.vim'
